...
import fr.diginamic.resttp05.exception.VirementNotFoundException;
import fr.diginamic.resttp05.model.Virement;
import fr.diginamic.resttp05.repository.iCrudVirement;
...
public class ControllerVirement {
	...
	public ResponseEntity<String> deleteVirement(@PathVariable("id") Integer pid) throws VirementNotFoundException {
		...
		cv.deleteById(pid);
		return ResponseEntity.status(HttpStatus.OK).body("Virement suprimé !");
